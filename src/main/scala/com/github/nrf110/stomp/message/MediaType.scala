...
// adapted from
// https://github.com/spray/spray/blob/6919e8faf6d5f148d703641b21214e5e025b128d/spray-http/src/main/scala/spray/http/MediaType.scala
...
object MediaTypes extends ObjectRegistry[(String, String), MediaType] {
   ...
   * STOMP layer you need to create an instance, register it via `MediaTypes.register` and use this instance in
