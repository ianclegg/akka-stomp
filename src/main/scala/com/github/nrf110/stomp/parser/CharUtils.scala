...
// adapted from
// https://github.com/spray/spray/blob/6919e8faf6d5f148d703641b21214e5e025b128d/spray-can/src/main/scala/spray/can/parsing/CharUtils.scala
...
object CharUtils {
  ...
  def abs(i: Int) = { val j = i >> 31; (i ^ j) - j }
